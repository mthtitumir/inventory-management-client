...
const Register = () => {
  ...
  const onFinish = async (values: any) => {
    ...
    const companyData = {
      ...
      companyLicenseNumber: companyLicense,
      address,
      country,
      province,
      city,
      ...
      >
        ...
        <Flex justify="center" align="center">
          <div style={{ width: "100%", margin: "50px" }}>
            ...
            >
              <RiChatQuoteLine style={{ fontSize: "40px" }} />
            </Divider>
            <p
              style={{
                fontWeight: "bold",
            ...
            >
              Our stock management system has become much better after using
              Flower Vista Inventory. We also switched to their Books for our
              accounting management for its seamless integration with Flower
              Vista Inventory.
            </p>
            ...
            <Flex justify="center" align="center" gap={20}>
              <Avatar
                size={40}
                src={
                  "https://www.hindustantimes.com/ht-img/img/2023/06/25/1600x900/Tristan_State_1687696831241_1687696831443.jpeg"
                }
              />
      ...
      >
        ...
        >
          ...
          <Space>
            ...
            >
              <Input prefix={<LiaCitySolid />} placeholder="Province" />
            </Form.Item>
            <Form.Item
              name="city"
