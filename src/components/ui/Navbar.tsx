...
const Navbar = () => {
    ...
    return (
        <Flex style={{ padding: "0 20px", marginBottom: "10px", borderBottom: '1px solid #e6f4ff', backgroundColor: "#e6f4ff"}} align={"center"} justify={"space-between"}>
            {/* {LogoNameContent} */}
            ...
            <Flex gap={8}>
                ...
                <Flex align="center" gap={8}>
                    <p>Mr. Test User</p>
                    <Avatar src={<UserAddOutlined style={{color:"black"}} />} style={{border: "1px solid #e6f4ff"}} />
                </Flex>
